...
curl -XPOST --user admin:admin -H "Content-Type: application/json" -d@news-2011.json http://localhost:8080/cms/rest/api/nodes/content/gallery/myhippoproject/news/